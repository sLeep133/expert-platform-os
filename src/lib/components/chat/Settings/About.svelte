	...
	<div class=" space-y-3 overflow-y-scroll max-h-[28rem] md:max-h-full">
			...
			<div class="flex w-full justify-between items-center">
				<div class="flex flex-col text-xs text-gray-700 dark:text-gray-200">
					<div class="flex gap-1">
						...
						{#if $config?.features?.enable_version_update_check}
							<a
								href="https://github.com/sLeep133/expert-platform-os/releases/tag/v{version.latest}"
								target="_blank"
							>
								{updateAvailable === null
		...
		{:else}
			<div class="flex space-x-1">
				<a href="https://github.com/sLeep133/expert-platform-os" target="_blank">
					<img
						alt="Github Repo"
						src="https://img.shields.io/github/stars/sLeep133/expert-platform-os?style=social&label=Star us on Github"
					/>
				</a>
			</div>
		{/if}
